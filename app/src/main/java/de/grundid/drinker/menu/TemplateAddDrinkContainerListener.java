...
public class TemplateAddDrinkContainerListener implements View.OnClickListener {
	...
	public TemplateAddDrinkContainerListener(TemplateDrinkActivity activity, TemplateDrinkAdapter templateDrinkAdapter,
			List<Object> elements, MenuDrinkContainer menuDrink) {
