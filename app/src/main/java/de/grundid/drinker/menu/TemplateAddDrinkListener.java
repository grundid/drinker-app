...
public class TemplateAddDrinkListener implements View.OnClickListener {
	...
	public TemplateAddDrinkListener(TemplateDrinkActivity activity, MenuDrinkContainer menuDrink,
			TemplateDrinkAdapter templateDrinkAdapter) {
					...
					.setPositiveButton(
							"Hinzufügen", new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									...
									volumePrice.setPrice(DrinkModelHelper.parseDrinkPrice(price.getText()));
									volumePrice.setVolume(DrinkModelHelper.parseDrinkVolume(volume.getText()));
									drink.addVolumePrice(volumePrice);
									if (price.getText() != null && volume.getText() != null
											&& drink.getName() != null) {
